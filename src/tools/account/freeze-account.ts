...
const freezeAccountParameters = (_context: Context = {}) =>
  z.object({
    tokenId: z.string().describe('The Hedera token ID of the stablecoin (e.g., "0.0.123456")'),
    targetId: z.string().describe('The Hedera account ID to freeze (e.g., "0.0.789012")'),
  });
...
export class FreezeAccountTool extends BaseTool {
  ...
  async coreAction(request: FreezeAccountRequest, _context: Context, _client: Client) {
    const response = await StableCoin.buildFreeze(request);
